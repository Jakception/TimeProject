...
namespace TimeProject.Models.Class
{
    class Projet
    {
        ...
        public Projet(int code_Projet, int id_Bc, int id_Archi, int id_User, string nom_Projet, string nom_Client, string adresse_Client, string ville_Client, DateTime dt_Deb_Projet, DateTime dt_Obj_Fin, DateTime dt_Fin_Reel)
        {
